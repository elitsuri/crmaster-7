"""
crmaster - Backend API
CRMaster: CRM with pipeline management, email sequences, and analytics
"""
...
app = FastAPI(
    title="crmaster",
    description="CRMaster: CRM with pipeline management, email sequences, and analytics",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "crmaster"}
